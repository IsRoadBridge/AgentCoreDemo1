...
执行结果: {'messages': [HumanMessage(content='Hi there!', additional_kwargs={}, response_metadata={}, id='20075957-c8b0-48c7-ae29-e80cbf8a5916'),
                        AIMessage(content='Hello from node 1', additional_kwargs={}, response_metadata={}, id='79b558eb-fbdc-4281-bf89-ee49ca168918',
                                  tool_calls=[], invalid_tool_calls=[]), AIMessage(content='Hello from node 2', additional_kwargs={}, response_metadata={},
                                                                                   id='362b21a1-2b9c-4c3e-abf5-d7f7c5c6061c', tool_calls=[], invalid_tool_calls=[])]}
